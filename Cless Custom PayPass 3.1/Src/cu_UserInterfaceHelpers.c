...
#include "cu_UserInterfaceHelpers.h"
...
{	
	...
	//APEMV_UI_MessageDisplayDelay("BBBB.06",2);
...
int cu_HelperDisplayMenu( const char* szTitle, int nDefaultChoice,
					   int nItems, const char* Items[],
					   int nBanners )
{
...
int cu_HelperNumericInput(const char* szTitle, const char* szLabel, int nMinLength, int nMaxLength, const char* szDefault, char* szInput)
{
	int nSizeX;
	int nSizeY;
	StructList Input;
