...
const char gs_DefaultParam[] =
{
	...
	"				<node tag=\"0x9F91851C\"> 00 00 00 00 20 00 </node>					<!-- TAG_PAYPASS_CLESS_TRANSACTION_LIMIT_NO_DCV : 20.00 -->"
	"				<node tag=\"0x9F91851D\"> 00 00 00 00 20 00 </node>					<!-- TAG_PAYPASS_CLESS_TRANSACTION_LIMIT_DCV : 20.00 -->"
