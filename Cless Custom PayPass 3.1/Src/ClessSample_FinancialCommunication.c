...
static int __ClessSample_FinancialCommunication_IsCommComponentLoaded (const unsigned short ucAppliType);
...
static int __ClessSample_FinancialCommunication_IsCommComponentLoaded (const unsigned short ucAppliType)
{
	...
	return (ObjectGetDescriptor(OBJECT_TYPE_APPLI, ucAppliType, &descriptor) == 0);
}
