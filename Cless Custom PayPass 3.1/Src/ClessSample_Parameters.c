...
const char gs_DefaultParam[] =
{
	...
	"				<node tag=\"0x9F92810E\"> 00 00 00 04 00 00 </node>					<!-- TAG_EP_CLESS_CVM_REQUIRED_LIMIT: 10 euros -->"
	"				<node tag=\"0x9F1B\"> 00 00 05 AA </node>							<!-- TAG_EMV_TERMINAL_FLOOR_LIMIT : 14,50 euros -->"
	"				<node tag=\"0x9F1A\"> 05 04 </node>									<!-- TAG_EMV_TERMINAL_COUNTRY_CODE -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	...
	"				<node tag=\"0x9F92810E\"> 00 00 00 04 00 00 </node>					<!-- TAG_EP_CLESS_CVM_REQUIRED_LIMIT -->"
	...
	"				<node tag=\"0x9F91851C\"> 99 99 99 99 99 99 </node>					<!-- TAG_PAYPASS_CLESS_TRANSACTION_LIMIT_NO_DCV : 20.00 -->"
	"				<node tag=\"0x9F91851D\"> 99 99 99 99 99 99 </node>					<!-- TAG_PAYPASS_CLESS_TRANSACTION_LIMIT_DCV : 20.00 -->"
	"				<node tag=\"0x9F92810E\"> 00 00 00 04 00 00 </node>					<!-- TAG_EP_CLESS_CVM_REQUIRED_LIMIT : 10.00 -->"
	"				<node tag=\"0x9F92810F\"> 00 00 00 00 00 00 </node>					<!-- TAG_EP_CLESS_FLOOR_LIMIT : 15.00 -->"
	"				<node tag=\"0x9F1B\"> 00 00 00 00 </node>							<!-- TAG_EMV_TERMINAL_FLOOR_LIMIT : 14.50 -->"
	...
	"				<node tag=\"0x9F918504\"> E0 60 C8 </node>							<!-- TAG_PAYPASS_TERMINAL_CAPABILITIES_CVM_REQ : E0 68 C8 (Online PIN, Signature and No CVM) -->"
	...
	"				<node tag=\"0x9F918523\"> E0 </node>								<!-- TAG_PAYPASS_CARD_DATA_INPUT_CAPABILITY -->"
	"				<node tag=\"0x9F918526\"> 28 </node>								<!-- TAG_PAYPASS_MCHIP_CVM_CAPABILITY_CVM_NOT_REQUIRED -->"
	"				<node tag=\"0x9F918524\"> F8 </node>								<!-- TAG_PAYPASS_SECURITY_CAPABILITY -->"
	"				<node tag=\"0x9F1A\"> 05 04 </node>									<!-- TAG_EMV_TERMINAL_COUNTRY_CODE -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	...
	"				<node tag=\"0x9F92810E\"> 00 00 00 04 00 00 </node>					<!-- TAG_EP_CLESS_CVM_REQUIRED_LIMIT : 20.00 -->"
	...
	"				<node tag=\"0x9F918704\"> A90FCD55AA2D5D9963E35ED0F4401776"
	...
	"										08867DEC40FAAECD740C00E2B7A8852D </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 5BED4068D96EA16D2D77E03D6036FC7A160EA99C </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	...
	"				<node tag=\"0x9F918704\">	9C6BE5ADB10B4BE3DCE2099B4B210672"
	"								B89656EBA091204F613ECC623BEDC9C6"
	"								D77B660E8BAEEA7F7CE30F1B153879A4"
	"								E36459343D1FE47ACDBD41FCD710030C"
	"								2BA1D9461597982C6E1BDD08554B726F"
	"								5EFF7913CE59E79E357295C321E26D0B"
	"								8BE270A9442345C753E2AA2ACFC9D308"
	"								50602FE6CAC00C6DDF6B8D9D9B4879B2"
	"								826B042A07F0E5AE526A3D3C4D22C72B"
	"								9EAA52EED8893866F866387AC05A1399 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> EC0A59D35D19F031E9E8CBEC56DB80E22B1DE130 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 01 </node>"
	"				<node tag=\"0x9F918704\">	C696034213D7D8546984579D1D0F0EA5"
	...
	"								7E1E79B285DD5771B5D9FF79EA630B75 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 8C05A64127485B923C94B63D264AF0BF85CB45D9 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 02 </node>"
	"				<node tag=\"0x9F918704\">	A99A6D3E071889ED9E3A0C391C69B0B8"
	"								04FC160B2B4BDD570C92DD5A0F45F53E"
	"								8621F7C96C40224266735E1EE1B3C062"
	"								38AE35046320FD8E81F8CEB3F8B4C97B"
	"								940930A3AC5E790086DAD41A6A4F5117"
	"								BA1CE2438A51AC053EB002AED866D2C4"
	"								58FD73359021A12029A0C043045C1166"
	"								4FE0219EC63C10BF2155BB2784609A10"
	"								6421D45163799738C1C30909BB6C6FE5"
	"								2BBB76397B9740CE064A613FF8411185"
	"								F08842A423EAD20EDFFBFF1CD6C3FE0C"
	"								9821479199C26D8572CC8AFFF087A9C3 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 33408B96C814742AD73536C72F0926E4471E8E47 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 03 </node>"
	"				<node tag=\"0x9F918704\">	C2490747FE17EB0584C88D47B1602704"
	...
	"								C2A89A4A1649A59BE680574DD0B60145 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 5ADDF21D09278661141179CBEFF272EA384B13BB </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 04 </node>"
	"				<node tag=\"0x9F918704\">	A6 DA 42 83 87 A5 02 D7 DD FB 7A 74 D3 F4 12 BE"
	...
	"				<node tag=\"0x9F918704\">	B8048ABC30C90D976336543E3FD7091C"
	...
	"								C68D095AAC91B5F37E28BB49EC7ED597 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> EBFA0D5D06D8CE702DA3EAE890701D45E274C845 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 06 </node>"
	"				<node tag=\"0x9F918704\">	CB26FC830B43785B2BCE37C81ED33462"
	...
	"								74037E3B34AB747F </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> F910A1504D5FFB793D94F3B500765E1ABCAD72D9 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 09 </node>"
	"				<node tag=\"0x9F918704\">	967B6264436C96AA9305776A5919C70D"
	"								A796340F9997A6C6EF7BEF1D4DBF9CB4"
	"								289FB7990ABFF1F3AE692F12844B2452"
	"								A50AE075FB327976A40E8028F279B1E3"
	"								CCB623957D696FC1225CA2EC950E2D41"
	"								5E9AA931FF18B13168D661FBD06F0ABB </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 1D90595C2EF9FC6E71B0C721118333DF8A71FE21 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 22 </node>"
	"				<node tag=\"0x9F918704\">	BBE43877CC28C0CE1E14BC14E8477317"
	"								E218364531D155BB8AC5B63C0D6E284D"
	"								D24259193899F9C04C30BAF167D57929"
	"								451F67AEBD3BBD0D41444501847D8F02"
	"								F2C2A2D14817D97AE2625DC163BF8B48"
	"								4C40FFB51749CEDDE9434FB2A0A41099 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 008C39B1D119498268B07843349427AC6E98F807 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> 52 </node>"
	"				<node tag=\"0x9F918704\">	B831414E0B4613922BD35B4B36802BC1"
	"								E1E81C95A27C958F5382003DF646154C"
	"								A92FC1CE02C3BE047A45E9B02A9089B4"
	"								B90278237C965192A0FCC86BB49BC82A"
	"								E6FDC2DE709006B86C7676EFDF597626"
	"								FAD633A4F7DC48C445D37EB55FCB3B1A"
	"								BB95BAAA826D5390E15FD14ED403FA2D"
	"								0CB841C650609524EC555E3BC56CA957 </node>"
	"				<node tag=\"0x9F918703\"> 010001 </node>"
	"				<node tag=\"0x9F918702\"> DEB81EDB2626A4BB6AE23B77D19A77539D0E6716 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> EF </node>"
	"				<node tag=\"0x9F918704\">	A191CB87473F29349B5D60A88B3EAEE0"
	"								973AA6F1A082F358D849FDDFF9C091F8"
	"								99EDA9792CAF09EF28F5D22404B88A22"
	"								93EEBBC1949C43BEA4D60CFD879A1539"
	"								544E09E0F09F60F065B2BF2A13ECC705"
	"								F3D468B9D33AE77AD9D3F19CA40F23DC"
	"								F5EB7C04DC8F69EBA565B1EBCB4686CD"
	"								274785530FF6F6E9EE43AA43FDB02CE0"
	"								0DAEC15C7B8FD6A9B394BABA419D3F6D"
	"								C85E16569BE8E76989688EFEA2DF22FF"
	"								7D35C043338DEAA982A02B866DE53285"
	"								19EBBCD6F03CDD686673847F84DB651A"
	"								B86C28CF1462562C577B853564A290C8"
	"								556D818531268D25CC98A4CC6A0BDFFF"
	"								DA2DCCA3A94C998559E307FDDF915006"
	"								D9A987B07DDAEB3B </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 21766EBB0EE122AFB65D7845B73DB46BAB65427A </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> F1 </node>"
	"				<node tag=\"0x9F918704\">	A0DCF4BDE19C3546B4B6F0414D174DDE"
	"								294AABBB828C5A834D73AAE27C99B0B0"
	"								53A90278007239B6459FF0BBCD7B4B9C"
	"								6C50AC02CE91368DA1BD21AAEADBC653"
	"								47337D89B68F5C99A09D05BE02DD1F8C"
	"								5BA20E2F13FB2A27C41D3F85CAD5CF66"
	"								68E75851EC66EDBF98851FD4E42C44C1"
	"								D59F5984703B27D5B9F21B8FA0D93279"
	"								FBBF69E090642909C9EA27F898959541"
	"								AA6757F5F624104F6E1D3A9532F2A6E5"
	"								1515AEAD1B43B3D7835088A2FAFA7BE7 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> D8E68DA167AB5A85D8C3D55ECB9B0517A1A5B4BB </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> FB </node>"
	"				<node tag=\"0x9F918704\">	A9548DFB398B48123FAF41E6CFA4AE1E"
	...
	"								081F56326A71303D952BB336FF12610D </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 6C7289632919ABEE6E1163D7E6BF693FD88EBD35 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> FC </node>"
	"				<node tag=\"0x9F918704\">	B37BFD2A9674AD6221C1A001081C6265"
	...
	"								6ECF258F4148751BE5DA5A3BE6CC34BD </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 7FB377EEBBCF7E3A6D04015D10E1BDCB15E21B80 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0x9F06\"> A0 00 00 00 04 </node>"
	"				<node tag=\"0x9F22\"> FD </node>"
	"				<node tag=\"0x9F918704\">	B3572BA49AE4C7B7A0019E5189E142CF"
	...
	"								EDB6AE9E0A2F75310EA8961287241245 </node>"
	"				<node tag=\"0x9F918703\"> 03 </node>"
	"				<node tag=\"0x9F918702\"> 23CF0D702E0AEFE518E4FA6B836D3CD45B8AAA71 </node>"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	...
	""
	""
	"		<node tag=\"0xBF918820\">	<!-- TAG_SAMPLE_DE_PARAMETERS -->"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0D 03 9F 21 00 </node>		      	<!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data Needed' 9F21 -->"
	"				<node tag=\"0xBF918822\"> BF 91 85 0A 06 9F 21 03 12 01 01 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: 'Tags to Write Before GENAC' 9F21 -->"
	"			</node>"
	""    
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0C 06 5F 24 03 10 01 11 </node>		<!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data To Send' 5F24 -->"
	"				<node tag=\"0xBF918822\"> BF 91 85 06 06 9F 70 00 9F 71 00 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: 'Tags to Read' 9F70 and 9F71 -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0D 03 9F 5C 00 BF 91 85 0C 1D 9F 38 06 9F 5C 08 9F 40 05 9F 5E 0B 54 13 33 90 00 00 15 13 01 00 00 9F 5D 03 01 01 00 </node>      <!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data Needed' 9F5C, 'Data To Send' 9F38, 9F5E and 9F5D -->"
	"				<node tag=\"0xBF918822\"> BF 91 85 06 03 9F 70 00 </node>				<!-- TAG_SAMPLE_DET_PARAMETERS: 'Tags To Read' 9F70 -->"
	"				<node tag=\"0xBF918822\"> DF 61 08 11 11 11 11 11 11 11 11 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: Dummy DET data -->"
	"				<node tag=\"0xBF918822\"> DF 60 08 11 11 11 11 11 11 11 11 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: Dummy DET data -->"
	"				<node tag=\"0xBF918822\"> DF 61 08 11 11 11 11 11 11 11 11 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: Dummy DET data  -->"
	"				<node tag=\"0xBF918822\"> 9F 5C 08 11 11 11 11 11 11 11 11 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: Missing PDOL tag 9F5C -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0D 03 9F 5C 00 BF 91 85 0C 1D 9F 38 06 9F 5C 08 9F 40 05 9F 5E 0B 54 13 33 90 00 00 15 13 01 00 00 9F 5D 03 01 03 00 </node>      <!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data Needed' 9F5C, 'Data To Send' 9F38, 9F5E and 9F5D -->"
	"				<node tag=\"0xBF918822\"> 9F 5C 08 11 11 11 11 11 11 11 11 </node>		<!-- TAG_SAMPLE_DET_PARAMETERS: Missing PDOL tag 9F5C  -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0D 05 9F 91 85 4B 00 </node>			<!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data Needed' Proceed To First Write Flag -->"
	"				<node tag=\"0xBF918822\"> BF 91 85 06 03 9F 72 00 </node>				<!-- TAG_SAMPLE_DET_PARAMETERS: Dummy 'Tags To Read' 9F72 -->"
	"				<node tag=\"0xBF918822\"> 9F 91 85 4B 01 01 </node>						<!-- TAG_SAMPLE_DET_PARAMETERS: Proceed to Write Flag set -->"
	"			</node>"
	""
	"			<node tag=\"0x1000\">"
	"				<node tag=\"0xBF918821\"> BF 91 85 0C 03 9F 70 00 </node>				<!-- TAG_SAMPLE_DEK_PARAMETERS: 'Data To Send' 9F70 -->"
	"				<node tag=\"0xBF918822\"> 9F 91 85 4B 01 01 </node>						<!-- TAG_SAMPLE_DET_PARAMETERS: Proceed to Write Flag set -->"
	"			</node>"
	""
	"		</node> <!-- End node 0xBF918820 : TAG_SAMPLE_DE_PARAMETERS-->"
	""
	...
	"				<node tag=\"0x9F35\"> 21 </node>							<!-- TAG_EMV_TERMINAL_TYPE -->"
	""
...
/*	char FilePath_L[80];
	...
	return (!CS_Settings_Restore("AllConfGzip", pTree, SettingsDecoderTeliumXml, ""));
}
...
int ClessSample_Parameters_GetCaKeyData (TLV_TREE_NODE ParameterTlvTree, const unsigned char ucCaKeyIndex, const unsigned char * pRid, T_SHARED_DATA_STRUCT * pOutputDataStruct)
{
	...
	//APEMV_UI_MessageDisplayDelay("Get CaKey Data",2);
	//APEMV_UI_MessageDisplayDelayHexa(&ucCaKeyIndex,1,2);
					...
					if (pResearch != NULL)
					{
						...
						if (ucCaKeyIndex == pValue[0])
						{
							...
							if (pResearch != NULL)
							{
								...
								{
									//APEMV_UI_MessageDisplay("NULL.02",2);
							...
							if (pResearch != NULL)
							{
								//APEMV_UI_MessageDisplay("NULL.03",2);
								...
								if (cr != STATUS_SHARED_EXCHANGE_OK)
								{
									//APEMV_UI_MessageDisplay("NULL.04",2);
							...
							//APEMV_UI_MessageDisplay("NULL.05",2);
	...
	if (!bFound)
	{
		//APEMV_UI_MessageDisplay("NULL.06",2);
					...
					if (pResearch != NULL)
					{
						...
						if (ulSupportedListLength > 0)
						{
							...
							else if (usKernelId == DEFAULT_EP_KERNEL_INTERAC)
							{
								...
								{
									GTL_Traces_TraceDebug ("ClessSample_Parameters_CreateSupportedCertificateListForKernel : An error occured when adding the supported certificate list to the Interac AID structure");
									nResult = FALSE;
								}
							}
#endif
				...
				if (memcmp(pRid, TlvTree_GetData(pResearch), 5) == 0)
				{
					...
					if (pResearch != NULL)
					{
						...
						if (*pCertificateListLength > ulTempLength)
						{
							...
							//APEMV_UI_MessageDisplayDelayHexa(pCertificateList,ulTempLength,2);
						}
					}
				}
			}
...
int ClessSample_Parameters_GetCurrencyFromParameters(unsigned char *pCurrencyCode, char **pCurrencyLabel)
{
	...
	int i;
	static char *pMadLabel = "MAD";
	static char *pUsdLabel = "USD";
	static char *pEurLabel = "EUR";
	char ucCurrencyCode[4];

	GTL_Convert_DcbToAscii(pCurrencyCode, ucCurrencyCode, 1, 4);

	memcpy(ucCurrencyCode,StructInfoCaisse[0].DE,3); //Cless_ currency
	...
	if(memcmp(ucCurrencyCode,"504", 3) == 0)
	{
		*pCurrencyLabel = pMadLabel;
		return (TRUE);
	}
	else if(memcmp(ucCurrencyCode,"840", 3) == 0)
	{
		*pCurrencyLabel = pUsdLabel;
		return (TRUE);
	}
	else if(memcmp(ucCurrencyCode,"978", 3) == 0)
	{
