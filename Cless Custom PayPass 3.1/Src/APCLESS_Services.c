...
static Telium_service_desc_t __APCLESS_theServices[] = {
   { 0, AFTER_RESET, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, IS_NAME , (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, GIVE_YOUR_DOMAIN, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, GIVE_YOUR_SPECIFIC_CONTEXT, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, IS_STATE, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, IS_DELETE, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, MORE_FUNCTION, (Telium_callback)__APCLESS_ServicesManager, __APCLESS_SERVICES_PRIORITY_DEFAULT },

   { 0, CLESS_GIVE_INFO, (Telium_callback)__APCLESS_ServicesCless, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, CLESS_DEBIT_AID, (Telium_callback)__APCLESS_ServicesCless, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, CLESS_END, (Telium_callback)__APCLESS_ServicesCless, __APCLESS_SERVICES_PRIORITY_DEFAULT },

   { 0, CLESS_SERVICE_CUST_IMPSEL_GUI, (Telium_callback)__APCLESS_ServicesCless, __APCLESS_SERVICES_PRIORITY_DEFAULT },
   { 0, SERVICE_CUSTOM_KERNEL, (Telium_callback)__APCLESS_ServicesCless, __APCLESS_SERVICES_PRIORITY_DEFAULT },
...
static int __APCLESS_ServicesManager(unsigned int size, StructPt *data)
{
   ...
   switch(data->service)
   {
      ...
      case GIVE_YOUR_SPECIFIC_CONTEXT:
         result = APCLESS_ServicesManager_GiveYourSpecificContext(appliId, &data->Param.GiveYourSpecificContext.param_out);
         break;
...
static void __APCLESS_GiveInterface(unsigned short appliId)
{
   ...
   // Register services
   Telium_ServiceRegister((sizeof(__APCLESS_theServices) / sizeof(__APCLESS_theServices[0])), __APCLESS_theServices);
}
