...
void ClessSample_Discover_DebugActivation (int bActivate)
{
	...
	if (pSharedStructure != NULL)
	{
		...
		else
		{
			...
			{
				GTL_Traces_TraceDebug("ClessSample_Discover_DebugActivation : Error occured during Discover Debug activation (nResult = %02x)", nResult);
			}
		}
