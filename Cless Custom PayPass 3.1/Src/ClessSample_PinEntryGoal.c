...
static unsigned long __ClessSample_PinEntry_Open(T_GL_HSCHEME_INTERFACE interface);
static void __ClessSample_PinEntry_Close(T_GL_HSCHEME_INTERFACE interface);
static unsigned long __ClessSample_PinEntry_Refresh(T_GL_HSCHEME_INTERFACE interface, T_GL_HWIDGET label);
...
PinEntry_Status_e ClessSample_PinEntryGoal(T_GL_HGRAPHIC_LIB goalHandle, const char *title, const char *text, const char *help, PinEntry_Infos_t *pinEntryInfo, int *pinLength)
{
	...
	// Ask for a PIN entry
	pinEntryInterface.open = &__ClessSample_PinEntry_Open;
	pinEntryInterface.close = &__ClessSample_PinEntry_Close;
	pinEntryInterface.refresh = &__ClessSample_PinEntry_Refresh;
