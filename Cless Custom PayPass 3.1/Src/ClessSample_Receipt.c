...
void ClessSample_Receipt_PrintTransaction_INGENICO (T_SHARED_DATA_STRUCT * pTransaction, int nTicketType, int nTransactionResult, const int bSignatureRequested, int nCardHolderLang, int nAOSA)
{
...
void ClessSample_Receipt_PrintPayPass_INGENICO (T_SHARED_DATA_STRUCT * pTransaction, const int bMobileTransaction, const int nRequiredCvm, int nCardHolderLang)
{
	int nResult, nPosition;
	unsigned long ulTag;
	unsigned long ulReadLength;
