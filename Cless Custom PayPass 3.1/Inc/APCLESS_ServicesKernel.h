/**
* \file
* \brief This module implements all the services required by the contactless kernels.
*
* \author Ingenico
...
#ifndef APCLESS_SERVICES_KERNEL_H_INCLUDED
#define APCLESS_SERVICES_KERNEL_H_INCLUDED
...
#endif // APCLESS_SERVICES_KERNEL_H_INCLUDED
