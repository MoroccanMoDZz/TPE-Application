...
void ClessSample_XML_ConvertXmlToTlvTree (const char* szFilePath, TLV_TREE_NODE *pOutputTree, XMLs_StartElementCallback pStartFunction, XMLs_EndElementCallback pEndFunction, XMLs_DataCallback pDataFunction, int * pUseDefaultParameters);
 ...
 */
void ClessSample_XML_ConvertXmlBufferToTlvTree (const char * pBuffer, unsigned int nBufferLength, TLV_TREE_NODE *pOutputTree, XMLs_StartElementCallback pStartFunction, XMLs_EndElementCallback pEndFunction, XMLs_DataCallback pDataFunction, int * pUseDefaultParameters);
