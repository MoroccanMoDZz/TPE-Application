...
#ifdef __TELIUM3__
#define I_COMM_DEFAULT_TYPE_APPLI						0x57aa			//!< Default application type for the communication component.
#else
...
void cu_COMM_Set_Application_Type(unsigned short usAppType);

//! \brief retrieves the application type of the communication component.
//! \return The application type.
unsigned short cu_COMM_Get_Application_Type(void);
...
//! \brief retrieves information about the communication protocol.
...
//! \brief retrieves the status of the component.
//! \param[in] pInputDel a \ref DEL containing:
//! - The configuration of the component \ref TAG_COMM_CONFIG_ID (optional).
//! \return A \ref DEL containing:
//! - The status code \ref TAG_COMM_STATUS_CODE.
...
//! \brief retrieves the data of an asynchronously received message.
//! \param[in] pInputDel a \ref DEL containing:
//! - The configuration of the component \ref TAG_COMM_CONFIG_ID (optional).
//! - The calling mode \ref TAG_COMM_CALLING_MODE (optional).
//! \return A \ref DEL containing:
