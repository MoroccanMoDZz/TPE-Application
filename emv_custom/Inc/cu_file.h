...
#ifdef FILE_H
//STRUCT_GLOBAL_RAM_DATA S_GlobalRamData1;
...
#else
//extern STRUCT_GLOBAL_RAM_DATA S_GlobalRamData1;		//!< Global variable used to store data in Ram.
extern T_Global_Data_File S_GlobalRamData1;
...
#define DateNextTransf		S_GlobalRamData1.DateNextTransf			//!< alias on field, date of the next automatic data batch capture, of global variable.
#define ucMode2000			S_GlobalRamData1.ucMode2000				//!< alias on field, Boolean indicating if EMV 2000 is supported, of global variable.
#define g_no_serial			S_GlobalRamData1.g_no_serial				//!< alias on field serial number of global variable.
#define g_terminal_id		S_GlobalRamData1.g_terminal_id			//!< alias on field terminal ID of global variable.
#define usDefaultCurrency	S_GlobalRamData1.usDefaultCurrency		//!< alias on field default currency of global variable.
#define ucDelayAfterAtr		S_GlobalRamData1.ucDelayAfterAtr			//!< alias on field delay after answer to reset of global variable.
#ifdef _TOOLWARE_
