...
#define C_LG_ENGLISH			0//KT				// English language definition.
#define C_LG_SPANISH			2//KT				// Spanish language definition.
#define C_LG_LOCAL				3//KT				// Local language definition.

#define L_NBCURCY				35				//!< Number of managed currencies.
...
#define C_IEP_CURCY_MAD    0x0504				//!< Moroccan dirhams currency.
...
extern const TAppMsg ct_DefMess_Cmi[C_NB_DEFAULT_MESS_CMI];
...
extern char ct_KernelVersion[20];							//!< Kernel version.
