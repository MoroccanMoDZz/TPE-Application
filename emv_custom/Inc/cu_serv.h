...
#define CUSERV_PAIEMENT_NFOIS_TRANSACTION		8
#define CUSERV_PAIEMENT_DIFFERE_TRANSACTION		9
#define CUSERV_PAIEMENT_POURBOIRE_TRANSACTION	10
#define CUSERV_PAIEMENT_INTERCHANGE_TRANSACTION	11
...
//===========================================================================
//! \brief This function performs the initialization of the variable given as
//! parameter, used for menu display.
//! \param[out] pMenu : pointer on wStructList structure used for menu display.
//! \param[in] flag : Set to _ON_ or _OFF_. It indicates if the correction key
//! has to be managed.
//! \param[in] offset : table index for selection.
//===========================================================================
