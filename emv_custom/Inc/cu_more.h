...
#ifndef _TOOLWARE_
extern const NavigationListe NavigationEmv_cmi[8];	//!< Array for navigation menus.
#else
extern const NavigationListe NavigationEmv_cmi[9];	//!< Array for navigation menus.
#endif
