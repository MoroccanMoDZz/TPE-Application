...
#define TRANS_FILE_OPEN_ERROR					3						//!< Return code if an error occured at transaction file open.
#define TRANS_FILE_READ_ERROR					4						//!< Return code if an error occured at transaction file read.
#define TRANS_FILE_ADD_ERROR					5						//!< Return code if an error occured at transaction file write.
#define TRANS_FILE_GET_ERROR					6						//!< Return code if an error occured at transaction get in the file
#define TRANS_FILE_DEL_ERROR					7						//!< Return code if an error occured at transaction file suppression
...
//===========================================================================
void Init_Transaction_File(T_Transaction_File *pt_Tr_File, char * FilePath);
...
//===========================================================================
int Add_Transaction(T_Transaction_File *pt_Tr_File, TLV_TREE_NODE hInputTlvTree);
...
//! - \ref TRANS_FILE_NOT_EXISTING if the file doesn't exist.
//===========================================================================
int Get_Transaction(T_Transaction_File *pt_Tr_File, TLV_TREE_NODE *phOutputTlvTree, unsigned int Trans_pos, int * Trans_len);
...
//! - \ref TRANS_FILE_NOT_EXISTING if the file doesn't exist.
//===========================================================================
int Get_Next_Transaction(T_Transaction_File *pt_Tr_File, TLV_TREE_NODE *phOutputTlvTree, unsigned int *pt_trans_pos);
...
//! - \ref TRANS_FILE_NOT_EXISTING if the file doesn't exist.
//! - \ref TRANS_FILE_DEL_ERROR if an error occured during file erase.
//===========================================================================
int Del_Transaction_File(T_Transaction_File *pt_Tr_File);
...
//! - \ref TRANS_FILE_ADD_ERROR if an error occured at file writing.
//! - \ref TRANS_FILE_READ_ERROR if an error occured at file reading.
//! - \ref TRANS_FILE_OPEN_ERROR if the file open was not successfull.
//===========================================================================
int Copy_Valid_Trans(T_Transaction_File *pt_In_Tr_File, T_Transaction_File *pt_Out_Tr_File);
...
//===========================================================================
int Rename_Trans_File(T_Transaction_File *pt_In_Tr_File, T_Transaction_File *pt_Out_Tr_File);
