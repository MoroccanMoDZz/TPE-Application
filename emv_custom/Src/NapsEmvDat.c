...
//Signature
	...
	if (l_l_result == TRUE)
	{
		...
		CONVERT_htoa(l_uc_data,l_us_length,(PC)l_c_chaine);//belhadeg probleme des transactions rejetées
		Lg = (UC)l_us_length*2;
		for(cara=0;
...
/*		ShowTrace_Mouna("ad3");
	...
	char_asc(StructInfoPayment.PanSeqNumber,3,StructInfoPayment.PanSeqNum5F34);    // vérification verifone 18062019
