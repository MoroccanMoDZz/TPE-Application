...
T_GL_HGRAPHIC_LIB APEMV_UI_GoalHandle(void)
{
	if (__APEMV_UI_goalHandle == NULL)
	{
		...
		//Os__xprinta(GL_GraphicLib_GetFontName(__APEMV_UI_goalHandle));
		GL_GraphicLib_SetSkinedColor(__APEMV_UI_goalHandle, GL_COLOR_BUTTON_TEXT_UNFOCUSED, 0xFF3D3B3B); // 0xFF7A7A7A
		//GL_GraphicLib_SetSkinedColor(__APEMV_UI_goalHandle, GL_COLOR_BUTTON_BORDER_FOCUSED, 0xFFEB6D20);
		GL_GraphicLib_SetSkinedColor(__APEMV_UI_goalHandle, GL_COLOR_BUTTON_BACKGROUND_FOCUSED, 0xFFD15220);
		GL_GraphicLib_SetSkinedColor(__APEMV_UI_goalHandle, GL_COLOR_BUTTON_BACKGROUND_UNFOCUSED, 0xFFE66D30);
		GL_GraphicLib_SetSkinedColor(__APEMV_UI_goalHandle, GL_COLOR_BUTTON_TEXT_FOCUSED, GL_COLOR_BLACK);
	}

	return __APEMV_UI_goalHandle;
}
T_GL_HGRAPHIC_LIB APEMV_UI_GoalHandle__(void)
{
	if (__APEMV_UI_goalHandle == NULL)
	{
		__APEMV_UI_goalHandle = GL_GraphicLib_Create();
...
{
	////APEMV_UI_MessageDisplayDelay ((char *)"Found it APEMV_UI_GoalOpen", 1);
