...
//===========================================================================
void CUBATCH_GetNextTransfDate (Telium_Date_t *date_time)
{
	ReadGlobalData();
	memcpy(date_time, &DateNextTransf, sizeof(Telium_Date_t));
}


//===========================================================================
void CUBATCH_SetNextTransfDate (Telium_Date_t *date_time)
{
	memcpy(&DateNextTransf, date_time, sizeof(Telium_Date_t));
 	StoreGlobalData();
}
...
void CUBATCH_Create_Financial_Record (TLV_TREE_NODE *phOutputTLVTree)
{
	...
	static const unsigned long RequiredTags[] = {TAG_AIP, TAG_ATC, TAG_APPLI_USAGE_CONTROL, 
		...
		TAG_TRANSACTION_FORCED_ACCEPTANCE, TAG_TSI, TAG_ICC_DYNAMIC_NUMBER,TAG_PAYMENT_ACCOUNT_REFERENCE };
...
void CUBATCH_Create_Advice_Record (void)
{
	...
	static const unsigned long RequiredTags[] = {TAG_AIP, TAG_ATC, TAG_APPLI_USAGE_CONTROL, 
		...
		TAG_TSI,TAG_PAYMENT_ACCOUNT_REFERENCE };
	// TAG_TRANSACTION_CATEGORY_CODE;
