...
static const ST_PARAM_ROW tzApp[appEnd-appBeg] = {
	...
	{ appSerialItem,         lenSerialItem,        "\x03\x01\x00\x00\x08" },  // Com Port, Data Bits, Parity, Stop Bits, Baud Rate
	{ appSerialInit,         lenSerialInit,        "8N1115200" },             //              8         N        1         115200

	{ appModemItem,          lenModemItem,         "\x00\x01\x00\x08" },      // Mdm Type, Correction,   , Data Bits, Parity,   ,Baud Rate
	...
	{ appEthIpLocal,         lenEthIpLocal,        "192.10.2.53" },           // Local Ip Address
	{ appEthPort,            lenEthPort,           "6002" },                  // Port number

	{ appGprsRequirePin,     lenGprsRequirePin,    "1" },                     // Pin required?
	{ appGprsApn,            lenGprsApn,           "internet1.orange.ma" },   // Apn
	{ appGprsUser,           lenGprsUser,          "MEDINET" },               // User name
	{ appGprsPass,           lenGprsPass,          "MEDINET" },               // Password
	{ appGprsIpRemote,       lenGprsIpRemote,      "105.159.251.120" },       // Remote Ip Address
	{ appGprsPort,           lenGprsPort,          "6003" },                  // Port number
